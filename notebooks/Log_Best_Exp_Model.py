...
# Best hyperparameters: {'max_depth': 8, 'n_estimators': 407, 'learning_rate': 0.02003683741905377, 'subsample': 0.792214831963186, 'colsample_bytree': 0.8843326072189778}
# R2 score: 0.8267372250556946
# Mean squared error: 14.927645261023809
# Root mean squared error:3.8636310979470863
# Mean Absolute Pecentage error: 0.13315346028654643

# xgboost_1 =  XGBRegressor(random_state=42,**best_params)
xgboost_1 =  XGBRegressor(random_state=42,max_depth=9, n_estimators=437, learning_rate= 0.012706457541012496, subsample=0.6931194195294401, colsample_bytree= 0.9303143908925534)
...
mlflow.log_param("n_estimators", '437')
mlflow.log_param("max_depth", '9')
mlflow.log_param("learning_rate", '0.012706457541012496')
mlflow.log_param("subsample", '0.6931194195294401')
mlflow.log_param("colsample_bytree", '0.9303143908925534')
